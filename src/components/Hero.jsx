...
function Hero() {
    return (
        <div>
            ...
            <ul className="rules-list">
                ...
                <div className="rule-item">
                 ...
                 <div className="rule-item">
                    <p><b>*Weight*</b></p>
                    <p>
                        Select the maximum weight that allows you to
                        complete the set with the good form.
                    </p>
                </div>
            </ul>
            <small>
                * The first and second set should be at 75% and 85% of 
                your working weight used for the last two sets.
            </small>
            <h3>The Training Plan</h3>
            <p>
                The training plan uses a structure known as <b>Bro Split</b>
            ...
            <p>
                Complete all of the workouts below and track your progress ✅.
            </p>
        </div>
    )
}
